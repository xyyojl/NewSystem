<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="deletehotNew.aspx.cs" Inherits="admin_deletehotNew" %>
...
<asp:Content ID="Content2" runat="server" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM [hotNew] WHERE [ID] = @original_ID" 
