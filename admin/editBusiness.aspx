<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="editBusiness.aspx.cs" Inherits="admin_editBusiness" %>
...
<asp:Content ID="Content2" runat="server" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        UpdateCommand="UPDATE [business] SET [Title] = @Title, [Author] = @Author, [Time] = @Time, [Content] = @Content ,[PageCount] = @PageCount WHERE [ID] = @original_ID">  
        <DeleteParameters>
