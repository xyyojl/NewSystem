<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="deleteRecommend.aspx.cs" Inherits="admin_deleteRecommend" %>
...
<asp:Content ID="Content2" runat="server" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM [recommend] WHERE [ID] = @original_ID" 
