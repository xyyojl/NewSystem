<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="deleteBusiness.aspx.cs" Inherits="admin_deleteBusiness" %>
...
<asp:Content ID="Content2" runat="server" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM [business] WHERE [ID] = @original_ID" 
