<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="deleteTechnology.aspx.cs" Inherits="admin_deleteTechnology" %>
...
<asp:Content ID="Content2" runat="server" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM [technology] WHERE [ID] = @original_ID" 
        ...
        UpdateCommand="UPDATE [technology] SET [Title] = @Title, [Author] = @Author, [Time] = @Time, [Content] = @Content ,[PageCount] = @PageCount WHERE [ID] = @original_ID">
        <DeleteParameters>
