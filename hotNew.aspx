<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hotNew.aspx.cs" Inherits="hotNew" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>DoNews快讯</title>
...
<body>
            ...
            <div class="companyList commonList">
                <ul class="column-content">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [ID], [Title], [Time] FROM [hotNew]">
                    </asp:SqlDataSource>
                    </li>
                </ul>
            </div>
    ...
    <footer>
        ...
        <p>网站当前的在线人数是：<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
    </p>
    </footer>
